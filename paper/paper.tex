...
\affil[1]{Stockholm University, Stockholm, Sweden}
\affil[2]{Swedish House of Finance, Stockholm, Sweden}
\date{}
...
\textit{Affiliations refer to the period when the work was carried out.}
\end{center}
...
construct data for two empirical studies of decentralized markets.
\end{abstract}
...
of version 1 predates the first public release. This paper describes
version 1.1.0, which adds the public metadata-seeding interface
...
Claude, ChatGPT, and OpenAI Codex were used during later software maintenance
and manuscript editing. The author reviewed the resulting changes and remains
responsible for the software and manuscript.
...
metadata, and recorded inputs are distributed with the repository. The
\href{https://github.com/HanssonMagnus/dexamine/tree/d030990fa797c4b876bed2b7d474649bcfb1358e/paper/examples}{permanent example snapshot}
contains the files needed to reproduce all four swaps with dexamine 1.1.0.
They are also supplied as ancillary material with this preprint.
