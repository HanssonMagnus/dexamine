...
\url{https://github.com/HanssonMagnus/dexamine/tree/52616a612eca522bd069cc6afa0c86f8eb5c47e2} (tag v1.0.0) \\
\hline
...
Verified on Linux with Python 3.10. Requires Python 3.10 or newer, web3 6.15.0 or newer, and requests 2.31.0 or newer.
...
\url{https://github.com/HanssonMagnus/dexamine/blob/v1.0.0/docs/docs.md} \\
\hline
...
The implementation separates JSON-RPC retrieval, contract metadata resolution,
protocol parsers, and output construction. A reusable session loads contract interfaces
...
list of Uniswap router and periphery addresses. Other destinations and contract
...
The accompanying script \texttt{parse\_recorded\_transaction.py}
...
It replaces the RPC transport with fixture replay while exercising the same session,
parser, and output construction. Unexpected HTTP access is rejected. The committed
...
of version 1 predates the public v1.0.0 release; the release metadata identifies the
code distributed with this software article.
...
checking, the reproducible example, and the publication build. The author reviewed
