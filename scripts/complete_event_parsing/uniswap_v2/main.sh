...
/home/magnus/Git/HanssonMagnus/research/dexamine/scripts/complete_event_parsing/uniswap_v2/trueblocks_query/query_contract.sh $CONTRACT_ADDRESS $TRUEBLOCKS_OUTPUT_FILE_CSV
...
python /home/magnus/Git/HanssonMagnus/research/dexamine/scripts/complete_event_parsing/uniswap_v2/trueblocks_query/csv_to_json.py $TRUEBLOCKS_OUTPUT_FILE_CSV $TRUEBLOCKS_OUTPUT_FILE_JSON $TRUEBLOCKS_LOG_FILE

# Run the Python script for Dexamine parsing
#python ./dexamine_parsing/process_uniswap_v2_events.py $TRUEBLOCKS_OUTPUT_FILE_JSON $DEXAMINE_OUTPUT_FILE $DEXAMINE_LOG_FILE $CONTRACT_ADDRESS
python /home/magnus/Git/HanssonMagnus/research/dexamine/scripts/complete_event_parsing/uniswap_v2/dexamine_parsing/process_uniswap_v2_events.py $TRUEBLOCKS_OUTPUT_FILE_JSON $DEXAMINE_OUTPUT_FILE $DEXAMINE_LOG_FILE $CONTRACT_ADDRESS
