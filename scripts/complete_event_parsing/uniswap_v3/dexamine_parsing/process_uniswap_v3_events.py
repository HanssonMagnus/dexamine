"""
This is a user script that runs the Uniswap v3 parser with a set of argument.
...
def parse_transaction(
    ...
    try:
        ...
        events = uniswap_v3_parser.parse_all_v3_events(
            ...
            uniswap_v3_pair_abi=uniswap_v3_pair_abi_local,
...
column_types = {
    ...
    "event_index": "Int64",  # Changed to nullable integer type
    "tx_hash": "str",
    "from_address": "str",
    "to_address": "str",
    "value": "float64",
