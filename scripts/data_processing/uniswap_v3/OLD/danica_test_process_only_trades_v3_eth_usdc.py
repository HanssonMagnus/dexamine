...
file_out = (
    "/media/m2_front/research/data/trueblocks_lists/uniswap_v3/test_parse/node_test.csv"
)
...
def parse_transaction(block_number, index):
    ...
    try:
        ...
        uniswap_v3_pair_abi = general_helpers.load_abi(
            constants.PATH_UNISWAP_V3_PAIR_ABI
        )
