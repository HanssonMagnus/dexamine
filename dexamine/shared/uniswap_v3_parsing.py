...
########################################################################################
def get_v3_pair(
    *, node_url: str, v3_pair_address: str, uniswap_v3_pair_abi: Abi
) -> tuple[str, str]:
...
def get_v3_dex(*, node_url: str, v3_pair_address: str, uniswap_v3_pair_abi: Abi) -> str:
    """
    ...
    uniswap_v3_pair_abi (Abi): The ABI of the pool contract.
...
########################################################################################
# Uniswap v3 check functions
########################################################################################
def has_uniswap_v3_swap_event(topics_0: list[str]) -> bool:
    """
...
def has_uniswap_v3_mint_event(topics_0: list[str]) -> bool:
    """
...
def has_uniswap_v3_burn_event(topics_0: list[str]) -> bool:
    """
