...
from dexamine.parsers.uniswap_v2_parser import UniswapV2Event, UniswapV2Swap, UniswapV2Lp
...
def test_uniswap_v2_event_positive_reserves():
    ...
    event = UniswapV2Event("UniswapV2", "USDC", "WETH", 6, 18, 1000, 2000)
...
def test_uniswap_v2_event_negative_reserves():
    ...
    with pytest.raises(ValueError):
        UniswapV2Event("UNI", "ETH", "USDT", 18, 6, -1000, 2000)
########################################################################################
# Test for class UnsiwapV2Swap
########################################################################################
def test_uniswap_v2_swap_valid():
    """Test for UniswapV2Event class with 500 USDC and 1 ETH."""
    swap_event = UniswapV2Swap("UniswapV2", "USDC", "WETH", 6, 18, 1000, 2000,
                               500000000, 0, 0, 1000000000000000000)
...
def test_uniswap_v2_swap_invalid_amounts():
    ...
    with pytest.raises(ValueError):
        UniswapV2Swap("UNI", "ETH", "USDT", 18, 6, 1000, 2000, None, 100, 200, None)
...
def test_uniswap_v2_lp_valid_mint():
    ...
    lp_event = UniswapV2Lp("UniswapV2", "USDC", "WETH", 6, 18, 1000, 2000, 1000, 2000)
...
def test_uniswap_v2_lp_invalid_amounts():
    ...
    with pytest.raises(ValueError):
        UniswapV2Lp("UniswapV2", "USDC", "WETH", 6, 18, 1000, 2000, -1000, 2000)
...
def test_swap_and_lp_same_event_data_fields():
    ...
    expected_keys = {'amount_0', 'amount_0_in', 'amount_0_out', 'amount_1',
                     'amount_1_in', 'amount_1_out', 'decimals_0', 'decimals_1',
                     'dex_symbol', 'event_type', 'invariant', 'mid_price', 'reserve_0',
                     'reserve_1', 'symbol_0', 'symbol_1'}
